...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install firefly-ai[matrix]"
    ) from e
...
from firefly.config.paths import get_data_dir, get_media_dir
from firefly.config.schema import Base
from firefly.utils.helpers import safe_filename
