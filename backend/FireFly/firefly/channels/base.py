...
class BaseChannel(ABC):
    ...
    to integrate with the firefly message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from firefly.providers.transcription import OpenAITranscriptionProvider
                provider = OpenAITranscriptionProvider(api_key=self.transcription_api_key)
            else:
                from firefly.providers.transcription import GroqTranscriptionProvider
